...
?>
    <div class="col-md-12 main" style="padding-top: 20px;">
        ...
        <div class="row">
            <div class="col-md-3" >
                <center>
                    <img src="image_uploads/<?php echo $profile_image; ?>" width="100px" class="img-responsive" alt="profile-Image">
                    <br>
                    <form action="image_upload.php" method="post" enctype="multipart/form-data">
                        <input type="file" name="fileToUpload" accept="image/jpeg" id="fileToUpload"  class="btn-primary" style="width: 100%">
                        <input type="submit" value="UPLOAD PROFILE IMAGE" name="submit"  class="btn-info">
                    </form>
                </center>
            </div>
            <div class="col-md-5">
    ...
    <div class="col-md-12 main" style="padding-top: 20px;">
        ...
        <br><br><center><a href="edit_profile.php"><input type="submit" value="SAVE THE CHANGES" class="btn-info"></a>
       <a href="profile.php"><input type="button" value="BACK --> PROFILE" class="btn-info"></center></a><br>
        </form>
    </div>
    </div>
    <div class="clearfix"></div>
